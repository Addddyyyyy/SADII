                ...
                <div class="box">
                    <div class="box-header !border-b-0 !pb-0 flex justify-between">
                        <div>
                            ...
                            <div>
                                <p class="text-[.75rem] text-textmuted font-normal mb-0">Order Status and Tracking. Track
                                    your order from ship date to arrival. To begin, enter your order number.</p>
                            </div>
                        </div>
            ...
            <div class="xl:col-span-4 md:col-span-12 lg:col-span-12 col-span-12">
                <div class="box overflow-hidden">
                    <div class="box-header !border-b-0 !pb-1">
                        ...
                        <p class="text-[.75rem] mb-0 text-textmuted font-normal">A customer is an individual or business
                            that purchases the goods service has evolved to include real-time</p>
                    </div>
                    <div class="box-body !p-0 customers mt-1">
                        <div class="ti-list-group ti-list-group-flush">
                            <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                                <div class="flex">
                                    <img class="avatar avatar-md avatar-rounded my-auto me-4"
                                        src="{{ asset('backend/assets/images/faces/3.jpg') }}" alt="Image description">
                                    <div class="flex-grow">
                            ...
                            <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                                <div class="flex">
                                    <img class="avatar avatar-md avatar-rounded my-auto me-4"
                                        src="{{ asset('backend/assets/images/faces/11.jpg') }}" alt="Image description">
                                    <div class="flex-grow">
                                        <div class="flex items-center">
                                            <div class="mt-1">
                            ...
                            <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                                <div class="flex">
                                    <img class="avatar avatar-md avatar-rounded my-auto me-4"
                                        src="{{ asset('backend/assets/images/faces/17.jpg') }}" alt="Image description">
                                    <div class="flex-grow">
                                        <div class="flex items-center">
                                            <div class="mt-1">
                            ...
                            <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                                <div class="flex">
                                    <img class="avatar avatar-md avatar-rounded my-auto me-4"
                                        src="{{ asset('backend/assets/images/faces/15.jpg') }}" alt="Image description">
                                    <div class="flex-grow">
                                        <div class="flex items-center">
                                            <div class="mt-1">
                            ...
                            <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                                <div class="flex">
                                    <img class="avatar avatar-md avatar-rounded my-auto me-4"
                                        src="{{ asset('backend/assets/images/faces/6.jpg') }}" alt="Image description">
                                    <div class="flex-grow">
                                        <div class="flex items-center">
                                            <div class="mt-1">
                    ...
                    <div class="product-timeline box-body !pt-3">
                        <ul class="timeline-1 mb-0">
                            <li class="!mt-0"> <i
                                    ...
                                    class="font-medium mb-4 text-[.875rem]">Total Products</span> <a
                            ...
                            <li class="!mt-0"> <i
                                    ...
                                    class="font-medium mb-4 text-[.875rem]">Total Sales</span> <a
                            ...
                            <li class="!mt-0"> <i
                                    ...
                                    class="font-medium mb-4 text-[.875rem]">Total Revenue</span> <a
                            ...
                            <li class="!mt-0"> <i
                                    ...
                                    class="font-medium mb-4 text-[.875rem]">Total Profit</span> <a
            ...
            <div class="xl:col-span-4 md:col-span-12 lg:col-span-6 col-span-12">
                <div class="box">
                    <div class="box-header !border-b-0 !pb-0">
                        ...
                        <p class="text-[.75rem] mb-0 text-textmuted font-normal">An order is an investor's instructions to
                            a broker or brokerage firm to purchase or sell</p>
                    </div>
