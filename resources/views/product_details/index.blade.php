                                    ...
                                    <div class="space-y-5">
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <p class="my-auto font-medium text-sm text-defaulttextcolor dark:text-white/70">
                                                A comfortable boarding house located in the heart of the city, offering clean and affordable accommodation for students and young professionals. Features include shared kitchen, laundry facilities, and 24/7 security.</p>
                                        </div>
                                        <div class="sm:flex sm:space-x-5">
                                            <h5 class="font-bold text-sm my-auto w-28 text-gray-800 dark:text-white">
                                                Status :</h5>
                                            <span class="my-auto font-medium text-sm text-success">Available 
                                            </span>
                                        </div>
                                        ...
                                        <div class="sm:flex sm:space-x-2">
                                            <h5 class="font-bold text-sm my-auto w-28 text-gray-800 dark:text-white">
                                                Location :</h5>
                                            <p class="text-defaulttextcolor dark:text-white/70 text-sm">123 Bayview Avenue, Suite 402, San Francisco, CA 94133</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-span-12 xxl:col-span-3">
                        <div class="box !shadow-none !border-0 mb-0 !bg-transparent">
                            <div class="box-body">
                                                ...
                                                <div class="" data-hs-input-number>
                                                    <div class="w-full flex justify-between items-center gap-x-3">
                                                      <div class="flex items-center gap-x-1.5">
                                                        ...
                                                        <input class="p-0 w-6 bg-transparent border-0 text-gray-800 text-center focus:ring-0 dark:text-white" type="text" value="1" data-hs-input-number-input>
                                ...
                                <p class="text-defaulttextcolor dark:text-white/70 text-sm text-center">Any Issue Regarding
                                    Booking ? <a href="javascript:void(0);" class="text-primary inline-flex"><i
                        ...
                        <div class="box-body !pt-0 !px-0">
                            ...
                            <div class="mt-6 px-6">
                                <div id="product-spec-content-2" class="" role="tabpanel"
                                    ...
                                    <h5 class="font-bold text-sm my-6">Amenities :</h5>
                                    <div class="grid grid-cols-2 gap-4">
                                        <div class="flex items-center space-x-3">
                                            <i class="ri-checkbox-circle-line text-primary text-lg"></i>
                                            <span class="text-defaulttextcolor dark:text-white/70">Free Wi-Fi</span>
                                        </div>
                                        <div class="flex items-center space-x-3">
                                            <i class="ri-checkbox-circle-line text-primary text-lg"></i>
                                            <span class="text-defaulttextcolor dark:text-white/70">Complimentary Breakfast</span>
                                        </div>
                                        <div class="flex items-center space-x-3">
                                            <i class="ri-checkbox-circle-line text-primary text-lg"></i>
                                            <span class="text-defaulttextcolor dark:text-white/70">Air Conditioning</span>
                                        </div>
                                        <div class="flex items-center space-x-3">
                                            <i class="ri-checkbox-circle-line text-primary text-lg"></i>
                                            <span class="text-defaulttextcolor dark:text-white/70">Daily Housekeeping</span>
                                        </div>
                                        <div class="flex items-center space-x-3">
                                            <i class="ri-checkbox-circle-line text-primary text-lg"></i>
                                            <span class="text-defaulttextcolor dark:text-white/70">24/7 Front Desk</span>
                                        </div>
                                        <div class="flex items-center space-x-3">
                                            <i class="ri-checkbox-circle-line text-primary text-lg"></i>
                                            <span class="text-defaulttextcolor dark:text-white/70">Secure Parking</span>
                                        </div>
                                        <div class="flex items-center space-x-3">
                                            <i class="ri-checkbox-circle-line text-primary text-lg"></i>
                                            <span class="text-defaulttextcolor dark:text-white/70">Laundry Facilities</span>
                                        </div>
                                        <div class="flex items-center space-x-3">
                                            <i class="ri-checkbox-circle-line text-primary text-lg"></i>
                                            <span class="text-defaulttextcolor dark:text-white/70">Shared Kitchen</span>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="box !shadow-none">
                                                    ...
                                                    <div class="flex space-x-4 rtl:space-x-reverse">
                                                        <div
                                                            ...
                                                            <img class="avatar avatar-sm !w-8 !h-8 ring-0 rounded-full"
                                                                src="../assets/images/faces/11.jpg" alt="avatar">
                                                            <div>
                                            ...
                                            <div class="box-body p-3">
                                                ...
                                                <p class="my-2 text-defaulttextcolor dark:text-white/70 text-xs">Very nice !
                                                    ...
                                                    beguiled and
                                                    demoralized.</p>
                                                <img src="../assets/images/ecommerce/17.png"
                                                    class="avatar rounded-sm p-2 border border-gray-200 dark:border-white/10"
                                                    alt="Product-image">
                                                <img src="../assets//images/ecommerce/13.png"
                                                    class="avatar rounded-sm p-2 border border-gray-200 dark:border-white/10"
                                                    alt="Product-image">
                                                <img src="../assets/images/ecommerce/14.png"
                                                    class="avatar rounded-sm p-2 border border-gray-200 dark:border-white/10"
                                                    alt="Product-image">
                                            </div>
                                                ...
                                                <div class="sm:flex justify-between">
                                                    <div class="flex space-x-4 rtl:space-x-reverse">
                                                        <div
                                                            class="flex items-center space-x-3 rtl:space-x-reverse">
                                                            <img class="avatar avatar-sm !w-8 !h-8 ring-0 rounded-full"
                                                                src="../assets/images/faces/14.jpg" alt="avatar">
                                                            <div>
                                ...
                                <div id="product-spec-content-1" class="hidden" role="tabpanel">
                                    <ul class="list-disc list-inside space-y-3 text-gray-900 dark:text-gray-200">
                                        ...
                                        <li>Pets are not allowed unless prior approval is obtained.</li>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        // Custom swiper initialization for product details
