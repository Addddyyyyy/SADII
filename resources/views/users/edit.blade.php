        ...
        <div class="my-auto">
            ...
            <nav>
                <ol class="flex items-center whitespace-nowrap min-w-0">
                    ...
                    <li class="text-[12px] text-gray-500">Edit</li>
                </ol>
            </nav>
        </div>
    </div>
    <div class="box custom-box">
        <form action="{{ route('users.update', $user) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="box-body">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        @if($user->photo)
                            <img src="{{ asset('storage/' . $user->photo) }}" alt="Current photo" class="w-20 h-20 object-cover mb-2 rounded">
                        @endif
            ...
            <div class="box-footer border-t border-defaultborder flex justify-end gap-2">
                ...
                <button type="submit" class="ti-btn ti-btn-primary !py-2 !px-4">Update User</button>
            </div>
        </form>
    </div>
</div>
