          ...
          <div class="box overflow-hidden !mb-0 !border-0 !shadow-none">
            <div class="action-header  flex items-center clearfix">
              <div class="float-start xs:hidden flex">
                <div class="avatar avatar-lg rounded-circle me-3"> <img src="{{ asset('backend/assets/images/faces/6.jpg') }}"
            ...
            <div class="box-body msg_card_body">
              ...
              <div class="flex justify-end ">
                ...
                <div class="img_cont_msg"> <img src="{{ asset('backend/assets/images/faces/9.jpg') }}" class="rounded-circle user_img_msg"
                    alt="img"> </div>
              </div>
              <div class="flex justify-start ">
                <div class="img_cont_msg"> <img src="{{ asset('backend/assets/images/faces/6.jpg') }}" class="rounded-circle user_img_msg"
      ...
      <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
        <div class="ti-modal-content !bg-[#3b4863] !border-0">
          <div class="mx-auto text-center p-[3rem]">
            ...
            <img src="{{ asset('backend/assets/images/faces/6.jpg') }}" class="rounded-full !h-[90px]  mt-4 mb-3 inline-flex" alt="img">
