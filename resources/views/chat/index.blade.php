...
@section('title')
    ...
    <div class="main-content">
        ...
        <div class="md:flex block items-center justify-between mb-6 mt-[2rem]  page-header-breadcrumb">
            <div class="my-auto">
                <h5 class="page-title text-[1.3125rem] font-medium text-defaulttextcolor mb-0">Messages</h5>
                <nav>
        ...
        <div class="main-chart-wrapper p-2 gap-2 lg:flex">
            <div class="chat-info border dark:border-defaultborder/10">
                <a aria-label="anchor" href="javascript:void(0)"
                    class="ti-btn bg-secondary text-white !font-medium ti-btn-icon !rounded-full chat-add-icon">
                ...
                <div class="flex items-center justify-between w-full p-4 border-b dark:border-defaultborder/10">
                    ...
                    <div class="hs-dropdown ti-dropdown">
                        <button aria-label="button" class="ti-btn ti-btn-icon ti-btn-secondary text-secondary" type="button"
                            aria-expanded="false">
                ...
                <div class="chat-search p-4 border-b dark:border-defaultborder/10">
                    <div class="input-group">
                        ...
                        <button aria-label="button" class="ti-btn ti-btn-light !rounded-s-none !mb-0" type="button"
                            id="button-addon2"><i class="ri-search-line text-textmuted"></i></button>
                    </div>
                </div>
                ...
                <div class="tab-content" id="myTabContent">
                                ...
                                <a href="javascript:void(0);" onclick="changeTheInfo(this,'McGreggor','10','online')">
                                    <div class="flex items-start">
                                        ...
                                        <div class="flex-grow">
                                            ...
                                            <p class="text-[0.75rem] mb-0">
                                                <span class="chat-msg text-truncate font-semibold text-textmuted">Nice to
                                                    meet you 😊</span>
                                                <span class="chat-read-icon ltr:float-right rtl:float-left align-middle"><i
                                                        class="ri-check-double-fill"></i></span>
                                            </p>
                    ...
                    <div class="tab-pane fade !border-0 chat-groups-tab hidden" id="groups-tab-pane"
                        ...
                        <ul class="list-none mb-0 mt-2">
                            <li class="!pb-0">
                                <p class="text-textmuted text-[0.6875rem] font-semibold mb-1 opacity-[0.7]">MY CHAT GROUPS
                                </p>
                            </li>
                            <li>
                                        ...
                                        <div class="flex-grow">
                                            <p class="mb-0 font-semibold">
                                                Friends Forever 😎 <span
                                                    class="ltr:float-right rtl:float-left text-textmuted font-normal text-[0.6875rem]">3
                                                    days
                                                    ago</span>
                                            </p>
                                            <p class="text-[0.75rem] mb-0">
                                        ...
                                        <div class="flex-grow">
                                            <p class="mb-0 font-semibold">
                                                Social Media Deals <span
                                                    class="ltr:float-right rtl:float-left text-textmuted font-normal text-[0.6875rem]">5
                                                    days
                                                    ago</span>
                                            </p>
                                            <p class="text-[0.75rem] mb-0">
                                        ...
                                        <div class="flex-grow">
                                            <p class="mb-0 font-semibold">
                                                Apartment Group <span
                                                    class="ltr:float-right rtl:float-left text-textmuted font-normal text-[0.6875rem]">12
                                                    days
                                                    ago</span>
                                            </p>
                                            <p class="text-[0.75rem] mb-0">
                ...
                <div class="sm:flex items-center p-2 border-b dark:border-defaultborder/10">
                    <div class="flex items-center leading-none">
                        ...
                        <div class="flex-grow">
                            <p class="mb-1 font-semibold text-[.875rem]">
                                <a href="javascript:void(0);"
                                    class="chatnameperson responsive-userinfo-open !text-defaulttextcolor dark:text-defaulttextcolor/70">Emiley
                                    Jackson</a>
                            </p>
                    ...
                    <div class="flex ms-auto">
                        ...
                        <button aria-label="button" type="button"
                            ...
                            <i
                                class="ti ti-user-circle dark:text-defaulttextcolor/70 dark:bg-bodybg !text-defaulttextcolor"></i>
                        </button>
                        <div class="hs-dropdown ti-dropdown">
                            <a aria-label="anchor" href="javascript:void(0);"
                                class="ti-btn ti-btn-icon ti-btn-outline-light dark:!bg-bodybg  hover:!text-defaulttextcolor dark:!border-defaultborder/10 !text-[0.95rem] !ms-2 font-semibold"
                                aria-expanded="false">
                                <i
                                    class="fe fe-more-vertical text-[0.8rem] dark:text-defaulttextcolor/70 !text-defaulttextcolor"></i>
                            </a>
                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden">
                                <li><a class="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-medium block"
                        ...
                        <button aria-label="button" type="button"
                            class="ti-btn ti-btn-icon ti-btn-outline-light dark:bg-bodybg  !text-[0.95rem] !ms-2 font-semibold responsive-chat-close">
                                    ...
                                    <div class="main-chat-msg">
                                        ...
                                        <div>
                                            <p class="mb-0 sm:flex block">
                                                <a aria-label="anchor" href="gallery.html"
            ...
            <div id="user-details" class="hs-overlay hidden ti-offcanvas ti-offcanvas-right !z-[105] !max-w-[22.975rem]"
                tabindex="-1">
                    ...
                    <div class="chat-user-details !border-0 dark:border-defaultborder/10" id="chat-user-details">
                        <div class="text-center mb-[3rem]">
                            ...
                            <p
                                ...
                                Emiley Jackson</p>
                            <p class="text-[0.75rem] text-textmuted !mb-4"><span
                            ...
                            <ul class="shared-files list-none">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="!text-[1.125rem]">
                                            <a aria-label="anchor" href="javascript:void(0)"><i
                                                    class="ri-download-2-line text-textmuted"></i></a>
                                        </div>
                                    </div>
                                </li>
                                <li class="!mb-4">
                                ...
                                <li>
                                    <div class="flex items-center">
                                        ...
                                        <div class="">
                                            <a aria-label="anchor" href="javascript:void(0)"><i
                                                    class="ri-download-2-line text-textmuted !text-[1.125rem]"></i></a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                        ...
                        <div class="mb-0">
                            <div class="font-semibold mb-4 text-defaultsize dark:text-defaulttextcolor/70">Photos &amp;
                                Media
