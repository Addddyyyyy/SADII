...
<body>
    ...
    <div class="ti-offcanvas-body !h-full overflow-auto" id="switcher-body">
      <div id="switcher-1" role="tabpanel" aria-labelledby="switcher-item-1" class="space-y-6">
        ...
        <div class="!mt-0 sidemenu-layout-styles">
          ...
          <div class="grid grid-cols-2 gap-2 switcher-style">
            <div class="flex">
              <input type="radio" name="sidemenu-layout-styles" class="ti-form-radio" id="switcher-default-menu"
                checked>
            ...
            <div class="flex">
              ...
              <label for="switcher-icontext-menu"
                class="text-defaultsize text-defaulttextcolor ms-2  font-semibold ">Icon
                Text</label>
            </div>
            <div class="flex">
            ...
            <div class="flex">
              ...
              <label for="switcher-double-menu"
                class="text-defaultsize text-defaulttextcolor ms-2  font-semibold">Double
                Menu</label>
            </div>
          </div>
        </div>
        <div class="!mt-0">
          ...
          <div class="grid grid-cols-3  switcher-style">
            ...
            <div class="flex">
              ...
              <label for="switcher-modern" class="text-defaultsize text-defaulttextcolor ms-2  font-semibold">
                Modern</label>
            </div>
          </div>
        </div>
          ...
          <div class="grid grid-cols-3 switcher-style">
            ...
            <div class="flex">
              ...
              <label for="switcher-boxed"
                class="text-defaultsize text-defaulttextcolor ms-2  font-semibold">Boxed</label>
            </div>
          </div>
        </div>
        <div class="!mt-0">
        ...
        <div class="ti-modal-content chat !border-0">
          <div class="box overflow-hidden !mb-0 !border-0 !shadow-none">
            <div class="action-header  flex items-center clearfix">
              <div class="float-start xs:hidden flex">
                <div class="avatar avatar-lg rounded-circle me-3"> <img
                    src="{{ asset('backend/assets/images/faces/6.jpg') }}" class="rounded-circle user_img" alt="img">
                </div>
              ...
              <ul class="ah-actions actions ms-auto items-center float-end">
                <li class="call-icon"> <a href="#" class="hidden md:block phone-button" data-hs-overlay="#audiomodal">
                    <i class="fe fe-phone"></i> </a> </li>
                <li class="video-icon"> <a href="#" class="hidden md:block phone-button" data-hs-overlay="#videomodal">
                    <i class="fe fe-video"></i> </a> </li>
            ...
            <div class="box-body msg_card_body">
              <div class="chat-box-single-line"> <abbr class="timestamp !text-defaulttextcolor">February 1st,
                  2019</abbr> </div>
              <div class="flex justify-start">
                <div class="img_cont_msg"> <img src="{{ asset('backend/assets/images/faces/6.jpg') }}"
                    class="rounded-circle user_img_msg" alt="img"> </div>
                <div class="msg_cotainer"> Hi, how are you Jenna Side? <span class="msg_time">8:40 AM, Today</span>
                </div>
              </div>
              ...
              <div class="flex justify-start ">
                <div class="img_cont_msg"> <img src="{{ asset('backend/assets/images/faces/6.jpg') }}"
                    class="rounded-circle user_img_msg" alt="img"> </div>
                <div class="msg_cotainer"> I am good too, thank you for your chat template <span class="msg_time">9:00
                    AM,
                    Today</span> </div>
              </div>
              <div class="flex justify-end ">
              ...
              <div class="flex justify-end mb-4">
                <div class="msg_cotainer_send"> But I must explain to you how all this mistaken born and I will give
              ...
              <div class="flex justify-start">
                <div class="img_cont_msg"> <img src="{{ asset('backend/assets/images/faces/6.jpg') }}"
                    class="rounded-circle user_img_msg" alt="img"> </div>
                <div class="msg_cotainer"> Okay Bye, text you later.. <span class="msg_time">9:12 AM, Today</span>
                </div>
              </div>
            </div>
        ...
        <div class="ti-modal-body">
          ...
          <div class="mt-5">
            ...
            <span class="search-tags text-[0.75rem] !py-[0rem] !px-[0.55rem]"><i class="fe fe-user me-2"></i>People<a
                href="javascript:void(0)" class="tag-addon header-remove-btn"><span class="sr-only">Remove
                  badge</span><i class="fe fe-x"></i></a></span>
  ...
  <script
    src="{{ asset('backend/assets/libs/filepond-plugin-image-preview/filepond-plugin-image-preview.min.js') }}"></script>
  <script
    src="{{ asset('backend/assets/libs/filepond-plugin-file-encode/filepond-plugin-file-encode.min.js') }}"></script>
  <script
    src="{{ asset('backend/assets/libs/filepond-plugin-file-validate-size/filepond-plugin-file-validate-size.min.js') }}"></script>
  <script
    src="{{ asset('backend/assets/libs/filepond-plugin-file-validate-type/filepond-plugin-file-validate-type.min.js') }}"></script>
  <script
    src="{{ asset('backend/assets/libs/filepond-plugin-image-edit/filepond-plugin-image-edit.min.js') }}"></script>
  <script
    src="{{ asset('backend/assets/libs/filepond-plugin-image-exif-orientation/filepond-plugin-image-exif-orientation.min.js') }}"></script>
  <script
    src="{{ asset('backend/assets/libs/filepond-plugin-image-crop/filepond-plugin-image-crop.min.js') }}"></script>
  <script
    src="{{ asset('backend/assets/libs/filepond-plugin-image-resize/filepond-plugin-image-resize.min.js') }}"></script>
  <script
    src="{{ asset('backend/assets/libs/filepond-plugin-image-transform/filepond-plugin-image-transform.min.js') }}"></script>
