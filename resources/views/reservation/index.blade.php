                    ...
                    <div class="box">
                        <div class="box-body flex items-center flex-wrap">
                            <div class="flex-grow"> <span
                                    ...
                                    reservation placed upto now : <span
                    ...
                    <div class="box">
                        <div class="box-header">
                            <div class="flex justify-between">
                                <div class="">
                                    <span class="text-sm font-semibold">Reservation Id</span>
                                    <span class="block text-xs text-gray-500 dark:text-white/70">#25256</span>
                                </div>
                                <div class="">
                                    <span class="fs-14 font-semibold">Reservation Date </span>
                        ...
                        <div class="box-body">
                            <div class="space-y-3">
                                <div class="sm:flex space-x-3 rtl:space-x-reverse">
                                    <img src="../assets/images/ecommerce/01.jpg" alt="product"
                                        class=" w-24 h-24 rounded-sm bg-gray-100 dark:bg-black/20 p-2">
                                    <div class="flex justify-between w-full">
                                        <div class="product-details space-y-1">
                                            <h5 class="text-lg font-semibold">Jam Gotera</h5>
                                            <p class="font-medium text-sm">Address : <span
                                                    class="text-gray-500 dark:text-white/70 text-xs  font-normal">
                                                    2nd street,houston texas,united states.</span>
                                            </p>
                                            <p class="font-medium text-sm">Check-in Date : <span
                                                    class="text-gray-500 dark:text-white/70 text-xs font-normal">
                                                    25 November</span>
                                            </p>
                                            <div><span class="font-medium text-sm ltr:mr-2 rtl:ml-2">Gender :
                                                </span><a class="text-info hover:underline"
                                                    href="order-details.html">Male</a></div>
                                        </div>
                        ...
                        <div class="box-body">
                            <div class="space-y-3">
                                <div class="sm:flex space-x-3 rtl:space-x-reverse">
                                    ...
                                    <div class="flex justify-between w-full">
                                        <div class="product-details space-y-1">
                                            <h5 class="text-lg font-semibold">Donald Trump</h5>
                                            <p class="font-medium text-sm">Address : <span
                                                    class="text-gray-500 dark:text-white/70 text-xs  font-normal">
                                                    2nd street,houston texas,united states.</span>
                                            </p>
                        ...
                        <div class="box-body">
                            <div class="space-y-3">
                                <div class="sm:flex space-x-3 rtl:space-x-reverse">
                                    ...
                                    <div class="flex justify-between w-full">
                                        <div class="product-details space-y-1">
                                            <h5 class="text-lg font-semibold">Lebron James</h5>
                                            <p class="font-medium text-sm">Address : <span
                                                    class="text-gray-500 dark:text-white/70 text-xs  font-normal">
                                                    2nd street,houston texas,united states.</span>
                                            </p>
                                            ...
                                            <div><span class="font-medium text-sm ltr:mr-2 rtl:ml-2">Gender :
                                                    ...
                                                    href="order-details.html">Female</a></div>
                                        </div>
                                        <div class="flex space-x-2 rtl:space-x-reverse">
                                        </div>
                                    </div>
