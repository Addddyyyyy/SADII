                ...
                <nav>
                    <ol class="flex items-center whitespace-nowrap min-w-0">
                        <li class="text-[12px]"> <a class="flex items-center text-primary hover:text-primary"
                                href="javascript:void(0);"> Profile <i
                        ...
                        <div class="sm:flex items-start !py-6 px-4 main-profile-cover">
                            ...
                            <div class="flex-grow main-profile-info">
                                <div class="flex items-center !justify-between">
                                    <h6 class="font-semibold mb-1 text-white text-[1rem]"><span>Name:
                                        </span>{{ ucfirst($user->name) }}</h6>
                                </div>
                                <h6 class="text-white "><span>Role: </span>{{ ucfirst($user->role) }}</h6>
                        ...
                        <div class="p-6 border-b border-dashed dark:border-defaultborder/10">
                            <div class="mb-6">
                                ...
                                <p class="text-[0.75rem] text-textmuted opacity-[0.7] mb-0 text-justify">
                                    I am <b class="!text-defaulttextcolor font-medium">John Doe,</b> a dedicated and
                                    approachable landlord committed to providing safe, comfortable, and well-maintained
                                    boarding spaces.
                                    I take pride in ensuring that all tenants feel at home, with clean facilities and a
                                    peaceful environment suitable for students and working professionals alike.
                                    I am responsive to concerns and always willing to assist with maintenance requests or
                                    inquiries.
                                    My goal is to create a friendly and respectful community where everyone can enjoy a
                                    convenient and secure living experience.
                                </p>
                            </div>
                        </div>
                        <div class="p-6 border-b border-dashed dark:border-defaultborder/10">
                            ...
                            <div class="text-textmuted">
                                ...
                                <p class="mb-0">
                                    <span class="avatar avatar-sm avatar-rounded me-2 bg-light text-textmuted">
                                        <i class="ri-map-pin-line align-middle text-[.875rem] text-textmuted"></i>
                                    </span>
